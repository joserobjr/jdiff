...
public class HTMLStatistics {
    ...
    public void emitStatistics(String filename, APIDiff apiDiff) {
        try (FileOutputStream fos = new FileOutputStream(filename);
            ...
            h_.writeText("      <TD BGCOLOR=\"#EEEEFF\" CLASS=\"NavBarCell1\"> <A HREF=\"jdiff_help" + HTMLReportGenerator.reportFileExt + "\"><FONT CLASS=\"NavBarFont1\"><B>Help</B></FONT></A>&nbsp;</TD>");
            h_.writeText("    </TR>");
            h_.writeText("  </TABLE>");
            h_.writeText("</TD>");
            ...
            h_.writeText("  &nbsp;<A HREF=\"jdiff_statistics" + HTMLReportGenerator.reportFileExt + "\" TARGET=\"_top\"><B>NO FRAMES</B></A></FONT></TD>");
            h_.writeText("</TR>");
    ...
    public void emitPackagesByDiff(APIDiff apiDiff) {
        ...
        for (PackageDiff pkg : apiDiff.packagesChanged) {
            ...
            h_.writeText("  <TD><A HREF=\"pkg_" + pkg.name_ + HTMLReportGenerator.reportFileExt + "\">" + pkg.name_ + "</A></TD>");
            h_.writeText("</TR>");
        }
    ...
    public void emitClassesByDiff(APIDiff apiDiff) {
        ...
        for (ClassDiff classDiff : allChangedClasses) {
            ...
            if (bucket != 0)
                ...
                h_.writeText("  <TD ALIGN=\"center\">&lt;1</TD>");
            h_.writeText("  <TD><A HREF=\"" + classDiff.name_ + HTMLReportGenerator.reportFileExt + "\">");
